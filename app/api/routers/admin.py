...
@router.get("/logs",
            ...
            description="관리자 전용: PII 검사 로그를 조회합니다. 필터링 및 페이징 지원.")
async def get_logs(
...
@router.get("/statistics/overview",
            ...
            summary="전체 통계 개요",
            description="관리자 전용: 지정된 기간의 전체 PII 검사 통계를 조회합니다.")
...
@router.get("/statistics/timeline",
            ...
            summary="시간대별 추세 분석",
            description="관리자 전용: 시간대별 PII 검사 추세를 조회합니다.")
...
@router.get("/statistics/by-pii-type",
            ...
            summary="PII 타입별 통계",
            description="관리자 전용: PII 타입별 탐지 통계를 조회합니다.")
...
@router.get("/statistics/by-ip",
            ...
            summary="IP별 통계",
            description="관리자 전용: IP 주소별 요청 및 탐지 통계를 조회합니다.")
